...
const char *nts[] = {"S", "USES", "USE", "RELATIVE_PATH", "MODULE", "GLOBALS",
    "GLOBAL", "ANNOTATIONS", "ANNOTATION", "FUNCTION", "TYPED_IDS",
    "EXPRESSION", "LITERAL", "ASSIGNMENT", "LHS", "TYPED_ID", "TYPE", "TYPES",
    "RHS", "DECLARATION", "CONTROL", "CONDITIONAL", "IF", "ELIF", "ELSE",
    "LOOP", "FOR", "WHILE", "STRUCT", "STRUCT_DEF", "SWITCH", "SWITCH_BODY",
    "SWITCH_CASE", "BLOCK", "STATEMENTS", "STATEMENT", NULL};
