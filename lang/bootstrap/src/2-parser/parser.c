...
const char *nts[] = {"S", "USES", "USE", "GLOBALS", "GLOBAL", "ANNOTATIONS",
    "ANNOTATION", "FUNCTION", "PARAMS", "PARAM", "EXPRESSION", "STRUCT_INST",
    "STRUCT_FIELD_INST", "EXPRESSION_LIST", "LITERAL", "TUPLE", "ASSIGNMENT",
    "DECLARATION", "TYPED_ID", "TYPE", "TUPLEDEF", "TYPES", "CONTROL",
    "CONDITIONAL", "IF", "ELIF", "ELSE", "SWITCH", "SWITCH_BODY", "SWITCH_CASE",
    "LOOP", "FOR", "WHILE", "STRUCT", "STRUCT_DEF", "IMPL", "IMPL_DEF",
    "EXTERN", "EXTERN_ARGS", "EXTERN_ARG", "BLOCK", "STATEMENTS", "STATEMENT",
    NULL};
