...
const char *nts[] = {"S", "USES", "USE", "RELATIVE_PATH", "MODULE", "GLOBALS",
    ...
    "EXPRESSION", "LITERAL", "ASSIGNMENT", "PRIMARY", "DECLARATION", "TYPED_ID",
    "TYPE", "TYPES", "CONTROL", "CONDITIONAL", "IF", "ELIF", "ELSE", "LOOP",
    "FOR", "WHILE", "STRUCT", "STRUCT_DEF", "SWITCH", "SWITCH_BODY",
