...
const char *nts[] = {"S", "USES", "USE", "RELATIVE_PATH", "MODULE", "GLOBALS",
    ...
    "FUNC_ARGS", "EXPRESSION", "LITERAL", "STRUCT_INST", "STRUCT_FIELD_INST",
    "ASSIGNMENT", "PRIMARY", "PRIMARY_SUB", "DECLARATION", "TYPED_ID", "TYPE",
    "TYPES", "CONTROL", "CONDITIONAL", "IF", "ELIF", "ELSE", "LOOP", "FOR",
    "WHILE", "STRUCT", "STRUCT_DEF", "IMPL", "IMPL_DEF", "SWITCH",
